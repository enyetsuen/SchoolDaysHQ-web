...
var ASM_CONSTS = {
  4195924: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4195979: ($0) => { performance.now = function() { return $0; }; },  
 4196027: ($0) => { performance.now = function() { return $0; }; },  
 4196075: () => { performance.now = Module['emscripten_get_now_backup']; }
};
