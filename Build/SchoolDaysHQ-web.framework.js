...
var ASM_CONSTS = {
  4189268: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4189323: ($0) => { performance.now = function() { return $0; }; },  
 4189371: ($0) => { performance.now = function() { return $0; }; },  
 4189419: () => { performance.now = Module['emscripten_get_now_backup']; }
};
