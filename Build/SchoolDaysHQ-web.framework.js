...
var ASM_CONSTS = {
  4196564: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4196619: ($0) => { performance.now = function() { return $0; }; },  
 4196667: ($0) => { performance.now = function() { return $0; }; },  
 4196715: () => { performance.now = Module['emscripten_get_now_backup']; }
};
