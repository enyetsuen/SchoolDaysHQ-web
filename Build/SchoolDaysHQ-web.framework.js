...
var ASM_CONSTS = {
  4195892: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4195947: ($0) => { performance.now = function() { return $0; }; },  
 4195995: ($0) => { performance.now = function() { return $0; }; },  
 4196043: () => { performance.now = Module['emscripten_get_now_backup']; }
};
